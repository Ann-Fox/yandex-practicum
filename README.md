...
* staged (англ. «подготовленный») / `indexed` / `cached`
...
# Тема: Работа над ошибками в коммитах
...
Можно внести правки в уже сделанный коммит с помощью опции `--amend` (от англ. amend — «исправить», «дополнить») у команды `commit: git commit --amend`
 ...
 Дополнить последний коммит забытым файлом common.css с помощью опции `--amend`.
